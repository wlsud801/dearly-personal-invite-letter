            ...
            >
                {isPlaying ? (
                    ...
                    >
                        ...
                        <circle cx="6" cy="18" r="3" />
                        <circle cx="18" cy="16" r="3" />
                        <line x1="2" y1="2" x2="22" y2="22" stroke="#99958f" strokeWidth="2" />
                    </svg>
                )}
            </button>
            {/* 줄무늬 배경 */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <img alt="" className="absolute w-full" src={'/images/intro/intro-bg.svg'} />
            </div>
            ...
            <div className="relative flex flex-col items-start w-full h-full">
                ...
                >
                    <div className="flex flex-col items-center w-full">
                        <div className="flex items-center justify-center pb-[6px] px-[10px] w-full">
                            <p
                        ...
                        <div className="flex gap-[10px] items-start">
                            <div className="flex items-center justify-center pb-[8px] pl-[10px]">
                                <p
                    ...
                    <div
                        ...
                        style={{
                            paddingTop: opened ? '4px' : '10px',
                            paddingBottom: opened ? '4px' : '10px',
                            transition: 'padding 1.2s ease-in-out',
                        }}
                    >
                        <div className="-scale-y-100 h-[5px] w-[20px]">
                            <img
                                alt=""
                    ...
                    {/* 05 . 31 . 2026 */}
                    <div className="flex items-center justify-center pb-[10px] w-full">
                        ...
                        <AnimatePresence>
                            {!opened && (
                                <motion.div
                                    ...
                                    className={`flex flex-col items-center pl-10 pr-[43px] pt-10 w-full ${!isOpening ? 'cursor-pointer' : 'pointer-events-none'}`}
                                    onClick={handleOpen}
                                >
                                    <div
                            ...
                            <img alt="" className="absolute block inset-0 max-w-none size-full" src={'/images/components/polaroid-narrow.svg'} />
                                        ...
                                        >
                                            <div
                                                ...
                                                style={{ marginLeft: '13.14px', marginTop: '13.89px', width: '168px' }}
                                            >
                                        ...
                                        >
                                            <div
                                                ...
                                                style={{ marginLeft: '9.59px', marginTop: '7.12px', width: '141px' }}
                                            >
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                style={{ marginLeft: '8.74px', marginTop: '16px', width: '179px' }}
                                            >
                                                <div style={{ transform: 'rotate(11deg)' }}>
                                                    ...
                                                    >
                                                        <div style={{ transform: 'rotate(20deg)' }}>
                                                            <div
                                                                ...
                                                                style={{ fontFamily: "'Rusilla Serif', serif" }}
                                                            >
                                                                <p className="text-[24.687px] leading-[0.8]">Save</p>
                ...
                <div className="relative z-10 shrink-0 flex flex-col items-center w-full pb-6">
                    <div className="flex items-center justify-center px-2 py-[10px] w-full">
                        <div
                            ...
                            style={{ fontFamily: "'Pretendard', sans-serif", fontSize: 'clamp(13px, 3.8vw, 16px)' }}
                        >
                            <p>
                                {WEDDING_YEAR}년 {WEDDING_MONTH}월 {WEDDING_DAY}일, {WEDDING_KO_DOW}요일{' '}
                                {WEDDING_TIME_KO}
                            </p>
                            <p>라루체 명동 5F 그레이스홀</p>
                        </div>
                    ...
                    <div className="flex items-center justify-center p-[6px] w-full">
                        <p
                            ...
                            style={{ fontFamily: "'Badoney', cursive", fontSize: 'clamp(11px, 3.5vw, 14px)' }}
                        >
