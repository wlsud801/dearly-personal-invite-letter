...
export default function InvitationSection() {
    ...
    return (
        <section ref={sectionRef} id="invitation-section" className="bg-[#f8f5f0] flex flex-col items-center px-8 py-12 gap-5">
            {/* INVITATION 헤더 */}
            <motion.div
                ...
                custom={0}
            >
                <img src={'/images/invitation/invitation_header.svg'} alt="INVITATION" className="h-[86px]" />
            </motion.div>
            ...
            <div className="flex flex-col items-center w-full">
                ...
                >
                    ...
                    <img src={'/images/invitation/present.svg'} alt="♥" className="w-[18px] h-5" />
                    <div className="flex items-center gap-1.5 text-black text-[16px] font-medium tracking-[-0.64px]">
                        <span>신부</span>
                        <span>혜빈</span>
                    </div>
