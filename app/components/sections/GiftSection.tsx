  ...
  return (
    <div className="w-full shadow-[2px_2px_4px_0px_rgba(0,0,0,0.15)] rounded-[10px]">
      <button
        type="button"
        onClick={onToggle}
        className={`flex items-center justify-between bg-white h-[50px] px-5 w-full shadow-[0px_0px_2px_0px_rgba(0,0,0,0.15)] ${
          open ? "rounded-t-[10px]" : "rounded-[10px]"
        }`}
      >
        <span className="text-black text-[15px] font-medium tracking-[-0.6px]">
          {label}
        </span>
        <ChevronDown
          className={`w-4 h-4 text-[#99958f] transition-transform duration-300 ${
...
export default function GiftSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-[#fffbf1] flex flex-col items-center px-12 py-12 gap-5"
    >
      <motion.img
      ...
      <motion.div
        ...
        custom={0.3}
      >
        <p className="text-black text-[16px] font-medium tracking-[-0.64px]">
          마음 전하실 곳
        </p>
        ...
        >
          ...
          >
            <AccountItem
              ...
              name="손재환"
              bank="우리은행"
              account="1002-939-574815"
            />
            <AccountItem
              label="신랑 부"
              name="손세호"
              bank="기업은행"
              account="080-011878-02-030"
            />
            <AccountItem
              label="신랑 모"
              name="이은정"
        ...
        >
          ...
          >
            <AccountItem
              ...
              name="김혜빈"
              bank="국민은행"
              account="611602-04-123103"
            />
            <AccountItem
              label="신부 부"
              name="김철규"
              bank="농협"
              account="754-02-015598"
            />
            <AccountItem
              label="신부 모"
              name="권영희"
